...
export default async function PlanCheckPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Plan-Check</h1>
      ...
      {!hasData ? (
        ...
        <>
          <div className="card flex flex-wrap items-center gap-4 text-sm">
            ...
            <Link href="/recurring" className="text-xs text-brand hover:underline">Planposten →</Link>
          </div>
          ...
          <div className="space-y-1 text-xs text-slate-400">
            ...
            <p>
              ...
              Monatsspalten zeigen die Verteilung. Betrag ggf. vor dem Übernehmen anpassen.
            </p>
          </div>
        </>
      )}
